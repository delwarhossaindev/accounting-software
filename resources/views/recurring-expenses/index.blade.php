...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1><i class="fas fa-redo mr-2"></i>Recurring Expenses</h1></div>
            <div class="col-sm-6">
                <a href="{{ route('recurring-expenses.create') }}" class="btn btn-primary float-sm-right">
                    <i class="fas fa-plus mr-1"></i> New Recurring Expense
                </a>
            </div>
        </div>
    </div>
                ...
                <table id="tbl" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('recurring-expenses.edit', $r) }}" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
                                <form action="{{ route('recurring-expenses.destroy', $r) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete?')">
                                    @csrf @method('DELETE')
