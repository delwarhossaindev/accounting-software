...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1><i class="fas fa-clock mr-2"></i>Aged Receivables</h1></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Aged Receivables</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                @if($report->isEmpty())
                    <div class="alert alert-info text-center">
                        <i class="fas fa-info-circle mr-2"></i> No outstanding receivables as of this date.
                    </div>
                @else
                <table id="agedTable" class="table table-bordered table-hover">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="text-right text-orange" style="color: #fd7e14;">31–60 Days</th>
